import { getLegalMoves, applyMove, opposite, plyColor, plyMoveNumber, moveToNotation } from "./draughtsMoves.js?v=20260923l";
import { moveNotation } from "./solutionParser.js?v=20260923l";
