import { getLegalMoves, applyMove, opposite, plyColor, plyMoveNumber, moveToNotation } from "./draughtsMoves.js?v=20260923p";
import { moveNotation } from "./solutionParser.js?v=20260923p";
