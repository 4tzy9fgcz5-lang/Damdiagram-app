import { createStartBoard } from "./board.js?v=20260923q";
import { applyMove, opposite } from "./draughtsMoves.js?v=20260923q";
import { maakWortel, voegZetToe } from "./zettenboom.js?v=20260923q";
