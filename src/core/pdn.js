import { createStartBoard } from "./board.js?v=20260923p";
import { applyMove, opposite } from "./draughtsMoves.js?v=20260923p";
import { maakWortel, voegZetToe } from "./zettenboom.js?v=20260923p";
