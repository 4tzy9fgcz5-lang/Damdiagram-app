import { createStartBoard } from "./board.js?v=20260923d";
import { applyMove, opposite } from "./draughtsMoves.js?v=20260923d";
import { maakWortel, voegZetToe } from "./zettenboom.js?v=20260923d";
