import { createStartBoard } from "./board.js?v=20260923k";
import { applyMove, opposite } from "./draughtsMoves.js?v=20260923k";
import { maakWortel, voegZetToe } from "./zettenboom.js?v=20260923k";
