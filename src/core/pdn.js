import { createStartBoard } from "./board.js?v=20260923j";
import { applyMove, opposite } from "./draughtsMoves.js?v=20260923j";
import { maakWortel, voegZetToe } from "./zettenboom.js?v=20260923j";
