import { createStartBoard } from "./board.js?v=20260923n";
import { applyMove, opposite } from "./draughtsMoves.js?v=20260923n";
import { maakWortel, voegZetToe } from "./zettenboom.js?v=20260923n";
