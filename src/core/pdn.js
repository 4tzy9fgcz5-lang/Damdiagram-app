import { createStartBoard } from "./board.js?v=20260923o";
import { applyMove, opposite } from "./draughtsMoves.js?v=20260923o";
import { maakWortel, voegZetToe } from "./zettenboom.js?v=20260923o";
