import { detectMultipleBoardCorners } from "./detectMultiBoard.js?v=20260921av";
import { fitCornersOnDrawable, findMissingBoardsOnDrawable } from "./detectBoard.js?v=20260921av";
