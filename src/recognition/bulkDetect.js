import { detectMultipleBoardCorners } from "./detectMultiBoard.js?v=20260923h";
import { fitCornersOnDrawable, findMissingBoardsOnDrawable } from "./detectBoard.js?v=20260923h";
