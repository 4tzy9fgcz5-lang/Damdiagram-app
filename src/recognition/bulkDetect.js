import { detectMultipleBoardCorners } from "./detectMultiBoard.js?v=20260923d";
import { fitCornersOnDrawable, findMissingBoardsOnDrawable } from "./detectBoard.js?v=20260923d";
