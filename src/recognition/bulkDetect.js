import { detectMultipleBoardCorners } from "./detectMultiBoard.js?v=20260923e";
import { fitCornersOnDrawable, findMissingBoardsOnDrawable } from "./detectBoard.js?v=20260923e";
