import { detectMultipleBoardCorners } from "./detectMultiBoard.js?v=20260923n";
import { fitCornersOnDrawable, findMissingBoardsOnDrawable } from "./detectBoard.js?v=20260923n";
