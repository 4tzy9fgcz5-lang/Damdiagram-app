import { detectMultipleBoardCorners } from "./detectMultiBoard.js?v=20260923j";
import { fitCornersOnDrawable, findMissingBoardsOnDrawable } from "./detectBoard.js?v=20260923j";
