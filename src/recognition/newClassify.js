...
//
//   import { createClassifier } from "./newClassify.js?v=20260917h";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260917h";
import { predict } from "./newModel.js?v=20260917h";
