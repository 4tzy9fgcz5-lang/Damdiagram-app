...
//
//   import { createClassifier } from "./newClassify.js?v=20260923h";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260923h";
import { predict } from "./newModel.js?v=20260923h";
