...
//
//   import { createClassifier } from "./newClassify.js?v=20260916f";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260916f";
import { predict } from "./newModel.js?v=20260916f";
