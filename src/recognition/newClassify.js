...
//
//   import { createClassifier } from "./newClassify.js?v=20260916a";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260916a";
import { predict } from "./newModel.js?v=20260916a";
