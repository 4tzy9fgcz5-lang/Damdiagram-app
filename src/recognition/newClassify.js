...
//
//   import { createClassifier } from "./newClassify.js?v=20260921s";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260921s";
import { predict } from "./newModel.js?v=20260921s";
