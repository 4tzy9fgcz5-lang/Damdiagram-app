...
//
//   import { createClassifier } from "./newClassify.js?v=20260925d";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260925d";
import { predict } from "./newModel.js?v=20260925d";
