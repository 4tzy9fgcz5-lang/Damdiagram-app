...
//
//   import { createClassifier } from "./newClassify.js?v=20260923d";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260923d";
import { predict } from "./newModel.js?v=20260923d";
