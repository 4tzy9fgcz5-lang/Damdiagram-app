...
//
//   import { createClassifier } from "./newClassify.js?v=20260915l";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260915l";
import { predict } from "./newModel.js?v=20260915l";
