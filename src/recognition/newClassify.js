...
//
//   import { createClassifier } from "./newClassify.js?v=20260924f";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260924f";
import { predict } from "./newModel.js?v=20260924f";
