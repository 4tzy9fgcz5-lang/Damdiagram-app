...
//
//   import { createClassifier } from "./newClassify.js?v=20260920a";
...
import { extractFeatures, toGray, boardRelative } from "./newFeatures.js?v=20260920a";
import { predict } from "./newModel.js?v=20260920a";
