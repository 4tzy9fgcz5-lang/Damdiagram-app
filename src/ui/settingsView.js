import { renderBackupSection, renderTrainingSection } from "./backupView.js?v=20260917f";
import { getVerbergOplossing, setVerbergOplossing } from "../db/uiSettings.js?v=20260917f";
