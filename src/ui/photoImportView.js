...
import { detectBoardCorners } from "../recognition/detectBoard.js?v=20260920a";
import { renderDiagramCapture } from "./diagramCaptureView.js?v=20260920a";
import { loadDrawable, drawableSize } from "./imageInput.js?v=20260920a";
