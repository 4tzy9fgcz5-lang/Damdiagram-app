...
import { loadDrawable, drawableSize, WORKING_MAX_SIDE } from "./imageInput.js?v=20260920m";
import { detectMultipleBoardCorners } from "../recognition/detectMultiBoard.js?v=20260920m";
