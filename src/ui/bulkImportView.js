...
import { detectBulkBoards } from "../recognition/bulkDetect.js?v=20260923h";
import { getList, addListValue } from "../db/lijsten.js?v=20260923h";
import { getAllCategorieen } from "../db/categorieen.js?v=20260923h";
import { createNumberReader, fillMissingNumbers } from "../recognition/numberOcr.js?v=20260923h";
import { splitOplossingenTekst } from "../core/solutionParser.js?v=20260923h";
import { OPLOSSING_OPDRACHT, kopieerNaarKlembord } from "./oplossingOpdracht.js?v=20260923h";
import { getOplossingenTekst, setOplossingenTekst } from "../db/uiSettings.js?v=20260923h";
import { setDefaultDoel } from "./editorView.js?v=20260923h";
