...
import { loadDrawable, drawableSize } from "./imageInput.js?v=20260923p";
import { detectBulkBoards } from "../recognition/bulkDetect.js?v=20260923p";
import { getList, addListValue } from "../db/lijsten.js?v=20260923p";
import { getAllCategorieen } from "../db/categorieen.js?v=20260923p";
import { createNumberReader, fillMissingNumbers } from "../recognition/numberOcr.js?v=20260923p";
import { splitOplossingenTekst } from "../core/solutionParser.js?v=20260923p";
import { OPLOSSING_OPDRACHT, kopieerNaarKlembord } from "./oplossingOpdracht.js?v=20260923p";
import { getOplossingenTekst, setOplossingenTekst } from "../db/uiSettings.js?v=20260923p";
import { setDefaultDoel } from "./editorView.js?v=20260923p";
