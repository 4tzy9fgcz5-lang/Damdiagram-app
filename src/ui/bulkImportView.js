...
import { loadDrawable, drawableSize } from "./imageInput.js?v=20260922a";
import { detectBulkBoards } from "../recognition/bulkDetect.js?v=20260922a";
import { getList, addListValue } from "../db/lijsten.js?v=20260922a";
import { getAllCategorieen } from "../db/categorieen.js?v=20260922a";
import { createNumberReader, fillMissingNumbers } from "../recognition/numberOcr.js?v=20260922a";
