...
import { loadDrawable, drawableSize } from "./imageInput.js?v=20260923m";
import { detectBulkBoards } from "../recognition/bulkDetect.js?v=20260923m";
import { getList, addListValue } from "../db/lijsten.js?v=20260923m";
import { getAllCategorieen } from "../db/categorieen.js?v=20260923m";
import { createNumberReader, fillMissingNumbers } from "../recognition/numberOcr.js?v=20260923m";
import { splitOplossingenTekst } from "../core/solutionParser.js?v=20260923m";
import { OPLOSSING_OPDRACHT, kopieerNaarKlembord } from "./oplossingOpdracht.js?v=20260923m";
import { getOplossingenTekst, setOplossingenTekst } from "../db/uiSettings.js?v=20260923m";
import { setDefaultDoel } from "./editorView.js?v=20260923m";
