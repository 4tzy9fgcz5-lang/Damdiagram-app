...
import { loadDrawable, drawableSize } from "./imageInput.js?v=20260923a";
import { detectBulkBoards } from "../recognition/bulkDetect.js?v=20260923a";
import { getList, addListValue } from "../db/lijsten.js?v=20260923a";
import { getAllCategorieen } from "../db/categorieen.js?v=20260923a";
import { createNumberReader, fillMissingNumbers } from "../recognition/numberOcr.js?v=20260923a";
import { splitOplossingenTekst } from "../core/solutionParser.js?v=20260923a";
import { OPLOSSING_OPDRACHT, kopieerNaarKlembord } from "./oplossingOpdracht.js?v=20260923a";
import { getOplossingenTekst, setOplossingenTekst } from "../db/uiSettings.js?v=20260923a";
import { setDefaultDoel } from "./editorView.js?v=20260923a";
