...
import { detectBulkBoards } from "../recognition/bulkDetect.js?v=20260923g";
import { getList, addListValue } from "../db/lijsten.js?v=20260923g";
import { getAllCategorieen } from "../db/categorieen.js?v=20260923g";
import { createNumberReader, fillMissingNumbers } from "../recognition/numberOcr.js?v=20260923g";
import { splitOplossingenTekst } from "../core/solutionParser.js?v=20260923g";
import { OPLOSSING_OPDRACHT, kopieerNaarKlembord } from "./oplossingOpdracht.js?v=20260923g";
import { getOplossingenTekst, setOplossingenTekst } from "../db/uiSettings.js?v=20260923g";
import { setDefaultDoel } from "./editorView.js?v=20260923g";
