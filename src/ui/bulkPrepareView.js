...
import { recognizeDiagram } from "./diagramCaptureView.js?v=20260923h";
import { parseOplossing } from "../core/solutionParser.js?v=20260923h";
import { orderForReview, reviewCounts } from "../core/bulkReview.js?v=20260923h";
