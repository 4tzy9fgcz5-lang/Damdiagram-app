...
import { recognizeDiagram } from "./diagramCaptureView.js?v=20260925a";
import { parseOplossing } from "../core/solutionParser.js?v=20260925a";
import { orderForReview, reviewCounts } from "../core/bulkReview.js?v=20260925a";
