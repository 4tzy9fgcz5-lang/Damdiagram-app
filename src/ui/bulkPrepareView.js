...
import { recognizeDiagram } from "./diagramCaptureView.js?v=20260923f";
import { parseOplossing } from "../core/solutionParser.js?v=20260923f";
import { orderForReview, reviewCounts } from "../core/bulkReview.js?v=20260923f";
