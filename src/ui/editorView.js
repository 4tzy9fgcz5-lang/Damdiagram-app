import { createBoardEditor, createPalette } from "./boardEditor.js?v=20260921bb";
import { createSolutionInput } from "./solutionInput.js?v=20260921bb";
import { parseOplossing, extractAuthor } from "../core/solutionParser.js?v=20260921bb";
import { createEmptyBoard, countPieces, isWhite, isBlack } from "../core/board.js?v=20260921bb";
import { parseFen, boardToFen, FenParseError } from "../core/fen.js?v=20260921bb";
import { parseStandInput, QuickTextParseError } from "../core/quicktext.js?v=20260921bb";
import { validateBoard } from "../core/validate.js?v=20260921bb";
import { saveStand, getStand, findDuplicates } from "../db/standen.js?v=20260921bb";
import { getList, addListValue } from "../db/lijsten.js?v=20260921bb";
import { getAllCategorieen } from "../db/categorieen.js?v=20260921bb";
import { logHerkenningCorrectie } from "../db/herkenningLog.js?v=20260921bb";
import { reclassifyFromDataUrl } from "./diagramCaptureView.js?v=20260921bb";
import { RECOGNITION_VERSION as NEW_MODEL_VERSION } from "../recognition/newClassify.js?v=20260921bb";
import { CNN_RECOGNITION_VERSION as CNN_MODEL_VERSION } from "../recognition/cnnClassify.js?v=20260921bb";

import { renderStarRating } from "./starRating.js?v=20260921bb";
