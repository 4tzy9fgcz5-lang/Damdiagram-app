import { createBoardEditor, createPalette } from "./boardEditor.js?v=20260914e";
import { createEmptyBoard, createStartBoard, mirrorBoard } from "../core/board.js?v=20260914e";
import { parseFen, boardToFen, FenParseError } from "../core/fen.js?v=20260914e";
import { parseQuickText, QuickTextParseError } from "../core/quicktext.js?v=20260914e";
import { validateBoard } from "../core/validate.js?v=20260914e";
import { saveStand, getStand, findDuplicates } from "../db/standen.js?v=20260914e";
import { getList, addListValue } from "../db/lijsten.js?v=20260914e";
import { logHerkenningCorrectie } from "../db/herkenningLog.js?v=20260914e";
import { CONFIDENCE_THRESHOLD } from "../recognition/classify.js?v=20260914e";
