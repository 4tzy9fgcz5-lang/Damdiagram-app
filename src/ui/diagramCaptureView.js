...
import { warpToSquareCanvas } from "../recognition/homography.js?v=20260925a";
import { classifyBoard, CONFIDENCE_THRESHOLD, RECOGNITION_VERSION } from "../recognition/classify.js?v=20260925a";
import {
  createClassifier as createNewClassifier,
  FLAG_BELOW as NEW_FLAG_BELOW,
  RECOGNITION_VERSION as NEW_RECOGNITION_VERSION,
} from "../recognition/newClassify.js?v=20260925a";
import {
  createCnnClassifier,
  CNN_FLAG_BELOW,
  CNN_RECOGNITION_VERSION,
} from "../recognition/cnnClassify.js?v=20260925a";
import { refineGrid } from "../recognition/gridRefine.js?v=20260925a";
import { checkPlausibility } from "../recognition/plausibility.js?v=20260925a";
import {
  buildCornersOverlay,
  buildGridOverlay,
  buildFieldCrops,
  buildRawFieldCrops,
} from "../recognition/debugRender.js?v=20260925a";
import { FIELD_COUNT, createEmptyBoard, PIECE_TYPES } from "../core/board.js?v=20260925a";
import { drawableSize, WORKING_MAX_SIDE } from "./imageInput.js?v=20260925a";
