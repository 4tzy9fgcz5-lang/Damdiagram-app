import { renderEditorView } from "./editorView.js?v=20260923f";
import { renderDatabaseView } from "./databaseView.js?v=20260923f";
import { renderEindspelenView } from "./eindspelenView.js?v=20260923f";
import { renderStandDetailView } from "./standDetailView.js?v=20260923f";
import { renderStencilsListView } from "./stencilsListView.js?v=20260923f";
import { renderStencilView, addStandenToStencil } from "./stencilView.js?v=20260923f";
import { saveStencil } from "../db/stencils.js?v=20260923f";
import { getLastBackupDate } from "./backupView.js?v=20260923f";
import { renderSettingsView } from "./settingsView.js?v=20260923f";
import { renderImportView } from "./importView.js?v=20260923f";
import { renderPhotoImportView } from "./photoImportView.js?v=20260923f";
import { renderBulkImportView } from "./bulkImportView.js?v=20260923f";
import { loadDrawable } from "./imageInput.js?v=20260923f";
import { renderBulkPrepare } from "./bulkPrepareView.js?v=20260923f";
import { reviewReason } from "../core/bulkReview.js?v=20260923f";
import { renderDiagramCapture, cropAroundCorners } from "./diagramCaptureView.js?v=20260923f";
import { listStanden } from "../db/standen.js?v=20260923f";
