import { renderEditorView } from "./editorView.js?v=20260925a";
import { renderDatabaseView } from "./databaseView.js?v=20260925a";
import { renderEindspelenView } from "./eindspelenView.js?v=20260925a";
import { renderStandDetailView } from "./standDetailView.js?v=20260925a";
import { renderStencilsListView } from "./stencilsListView.js?v=20260925a";
import { renderStencilView, addStandenToStencil } from "./stencilView.js?v=20260925a";
import { saveStencil } from "../db/stencils.js?v=20260925a";
import { getLastBackupDate } from "./backupView.js?v=20260925a";
import { renderSettingsView } from "./settingsView.js?v=20260925a";
import { renderImportView } from "./importView.js?v=20260925a";
import { renderPhotoImportView } from "./photoImportView.js?v=20260925a";
import { renderBulkImportView } from "./bulkImportView.js?v=20260925a";
import { loadDrawable } from "./imageInput.js?v=20260925a";
import { renderBulkPrepare } from "./bulkPrepareView.js?v=20260925a";
import { reviewReason } from "../core/bulkReview.js?v=20260925a";
import { renderDiagramCapture, cropAroundCorners } from "./diagramCaptureView.js?v=20260925a";
import { listStanden } from "../db/standen.js?v=20260925a";
import { renderPartijInvoer } from "./partijInvoerView.js?v=20260925a";
import { renderPartijenListView } from "./partijenListView.js?v=20260925a";
import { renderPartijDetailView } from "./partijDetailView.js?v=20260925a";
import { renderFilmModuleView } from "./filmModuleView.js?v=20260925a";
import { renderPartijAnnoteren } from "./partijAnnoterenView.js?v=20260925a";
