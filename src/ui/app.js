import { renderEditorView } from "./editorView.js?v=20260920b";
import { renderDatabaseView } from "./databaseView.js?v=20260920b";
import { renderStandDetailView } from "./standDetailView.js?v=20260920b";
import { renderStencilsListView } from "./stencilsListView.js?v=20260920b";
import { renderStencilView, addStandenToStencil } from "./stencilView.js?v=20260920b";
import { saveStencil } from "../db/stencils.js?v=20260920b";
import { getLastBackupDate } from "./backupView.js?v=20260920b";
import { renderSettingsView } from "./settingsView.js?v=20260920b";
import { renderImportView } from "./importView.js?v=20260920b";
import { renderPhotoImportView } from "./photoImportView.js?v=20260920b";
import { renderBulkImportView } from "./bulkImportView.js?v=20260920b";
import { renderDiagramCapture, cropAroundCorners } from "./diagramCaptureView.js?v=20260920b";
