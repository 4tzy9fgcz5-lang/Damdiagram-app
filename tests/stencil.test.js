import { describe, it, assertEqual, assertThrows } from "./test-runner.js?v=20260923b";
import { getGridLayout, computeCellRects, paginateItems, MAX_DIAGRAMS_PER_PAGE } from "../src/stencil/layout.js?v=20260923b";
import { buildStencilPagesHTML, missingOplossingen } from "../src/stencil/stencilPreview.js?v=20260923b";
import { opdrachtregelMetOndertitel } from "../src/stencil/compose.js?v=20260923b";
