import { describe, it, assertEqual, assertThrows, assertTrue } from "./test-runner.js?v=20260922a";
import {
  fieldToCoord,
  coordToField,
  mirrorField,
  ...
  boardsEqual,
  PIECE_TYPES,
} from "../src/core/board.js?v=20260922a";
import { parseFen, boardToFen, FenParseError } from "../src/core/fen.js?v=20260922a";
import { parseQuickText, QuickTextParseError } from "../src/core/quicktext.js?v=20260922a";
import { validateBoard } from "../src/core/validate.js?v=20260922a";
