...
import { buildGridOverlay, buildFieldCrops, buildRawFieldCrops } from "../src/recognition/debugRender.js?v=20260923f";
import { createEmptyBoard, PIECE_TYPES } from "../src/core/board.js?v=20260923f";
