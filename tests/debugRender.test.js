...
import { buildGridOverlay, buildFieldCrops } from "../src/recognition/debugRender.js?v=20260914f";
import { createEmptyBoard, PIECE_TYPES } from "../src/core/board.js?v=20260914f";
