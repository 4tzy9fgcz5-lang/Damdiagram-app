import { describe, it, assertTrue, assertEqual } from "./test-runner.js?v=20260921ax";
import { fitBoardQuad, findMissingBoards, patternSeparation } from "../src/recognition/quadFit.js?v=20260921ax";
...
describe("losse foto: bord in het midden met een ander diagram ernaast", () => {
  ...
  it("kiest het bord in het midden, niet een stuk van de buren of twee borden samen", async () => {
    ...
    const { detectPlayfieldFromImageData } = await import("../src/recognition/detectBoard.js?v=20260921ax");
