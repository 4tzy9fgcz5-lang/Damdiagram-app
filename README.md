...
**Over de fotoherkenning:** de app kijkt per veld naar helderheid ten opzichte van de andere velden op dezelfde foto, en past zich per foto aan (geen vaste drempel) — getest op 89% correct over 6 testfoto's, en op 85% over 22 echte, door Jan zelf gecorrigeerde herkenningen. Bij boekstijlen waar dat eerste signaal geen duidelijk onderscheid geeft (bijvoorbeeld een gearceerde achtergrond zonder scherp verschil tussen lege en bezette vakjes — dat gaf eerder soms "0 schijven herkend") valt de app automatisch terug op een tweede signaal: hoeveel het midden van een veld afwijkt van de geschatte achtergrond van het hele bord. Datzelfde tweede signaal redt ook losse gevallen waarbij één kleur (bijvoorbeeld een effen zwarte schijf) veel minder interne textuur heeft dan de andere en anders helemaal gemist zou worden. Een schijf op een veld waar dat volgens de spelregels niet kan (wit op 1-5, zwart op 46-50) wordt altijd als onzeker gemarkeerd. Voor de kleur (wit/zwart) wordt gekeken naar het midden van elk veld ten opzichte van een geschatte lichthelling over het hele bord (niet één vast gemiddelde) — zo telt een schaduw of een niet-platliggende bladzijde niet meer te snel mee als "zwart". Dammen worden bewust nooit automatisch herkend (dat bleek onbetrouwbaar): elk bezet veld wordt als gewone schijf voorgesteld, en jij tikt 'm in de editor gewoon nog een keer aan om naar een dam te wisselen. De app probeert de 4 hoeken van het bord nu ook zelf te vinden (aan de hand van de dikke rand die de meeste boeken om het bord drukken) zodra je een foto kiest — lukt dat niet overtuigend, dan krijg je de oude, vaste startpositie. In beide gevallen kun je de hoekpunten altijd nog verslepen voor je op "Rechttrekken en herkennen" klikt. Elke keer dat je een via een foto herkende stand opslaat, bewaart de app (alleen lokaal, nooit automatisch gedeeld) wat de herkenning dacht en wat de uiteindelijke stand werd — dat is materiaal om de herkenning later verder te trainen. Het komt gewoon mee in je back-up.

**Nog niet gebouwd** (latere fases): geavanceerd zoeken, en installeren als app-icoon op je beginscherm die ook offline werkt.
