...
const FULL_FEATURE_NAMES = FEATURE_NAMES.concat(FEATURE_NAMES.map((n) => `${n}_rel`));
 ...
 */
function boardRelative(rawVectors) {
...
module.exports = {
  extractFeatures, toGray, boardRelative,
  FEATURE_NAMES, FULL_FEATURE_NAMES, CENTER_R, BG_BAND, RING_R,
};
